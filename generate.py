...
if __name__ == "__main__":
  ...
  for p in pieces:
    ...
    # Attribute score
    orig_p_cls_str = ''.join(str(c) for c in p_data['polyph_cls_bar'])    # s^poly
    orig_r_cls_str = ''.join(str(c) for c in p_data['rhymfreq_cls_bar'])    # s^rhym
